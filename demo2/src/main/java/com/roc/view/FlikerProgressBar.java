...
public class FlikerProgressBar extends View implements Runnable {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            textSize = (int) typedArray.getDimension(R.styleable.FlikerProgressBar_textSize, 12);
            ...
            radius = (int) typedArray.getDimension(R.styleable.FlikerProgressBar_radius, 0);
            borderWidth = (int) typedArray.getDimension(R.styleable.FlikerProgressBar_borderWidth, 1);
        } finally {
            typedArray.recycle();
        }
    }
